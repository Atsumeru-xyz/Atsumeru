package xyz.atsumeru.web.archive.iterator;
...
//        logger.info("Reading archive: " + archivePath);
    ...
    public void reset() {
        ...
        iterator = entries.stream()
                ...
                .sorted((entry1, entry2) -> CaseInsensitiveSimpleNaturalComparator.getInstance().compare(entry1.getName().toLowerCase(), entry2.getName().toLowerCase()))
    ...
    public boolean saveIntoArchive(String filePath, Map<String, String> fileNameWithContentMap) {
        ...
        try {
            ...
            FileUtils.closeLoudly(fileSystem);
        }
    }
