...
import xyz.atsumeru.web.helper.JSONHelper;
...
import xyz.atsumeru.web.util.*;

import java.util.ArrayList;
import java.util.List;
import java.util.Optional;

import static xyz.atsumeru.web.helper.JSONLogHelper.putJSON;
    ...
    public static void fromJSON(BookChapter chapter, String json, String chapterFolder, String archivePath, String archiveHash) {
        ...
        chapter.setTitle(
                Optional.ofNullable(JSONHelper.getStringSafe(obj, "title"))
                        ...
                        .orElse(
                                Optional.ofNullable(chapterFolder)
                                        .filter(StringUtils::isNotEmpty)
                                        .map(FileUtils::getDirName)
    ...
    private static String getLinks(JSONObject obj) {
        ...
        if (linksArray != null) {
            for (Object object : linksArray) {
                if (object instanceof JSONObject linksObject) {
    ...
    private static List<BoundService> getBoundServices(JSONObject obj) {
        ...
        if (servicesArray != null) {
            for (Object object : servicesArray) {
                if (object instanceof JSONObject servicesObject) {
