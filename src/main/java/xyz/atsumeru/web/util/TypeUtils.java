...
public class TypeUtils {
    ...
    /**
     * Safely parses Long from String. If provided {@param value} can't be parsed, provided default {@param def}
    ...
    /**
     * Safely parses Double from String. If provided {@param value} can't be parsed, provided default {@param def}
     * value will be returned.
     *
     * @param value - input string for parsing
     * @param def   - default return value
    ...
    /**
     * Safely parses Float from String. If provided {@param value} can't be parsed, provided default {@param def}
     * value will be returned.
     *
     * @param value - input string for parsing
     * @param def   - default return value
    ...
    /**
     * Safely parses Integer from String. If provided {@param value} can't be parsed, provided default {@param def}
     * value will be returned.
     *
     * @param value - input string for parsing
     * @param def   - default return value
    ...
    /**
     * Safely parses Boolean from String. If provided {@param value} can't be parsed, provided default {@param def}
     * value will be returned.
     *
     * @param value - input string for parsing
     * @param def   - default return value
